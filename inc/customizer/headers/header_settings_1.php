<?php
add_action( 'customize_register', 'forest_add_headers_customizer_panel' );
function forest_add_headers_customizer_panel($wp_customize){
    // Top header color
    $wp_customize->add_panel('forest_headers_pannel',[
        'title'=>__('Forest headers', 'forest'),
        'priority'=>15,
    ]);
...
function forest_choose_custom_header($wp_customize){

      $wp_customize->add_section('forest_change_header_section',[
          'title'=>__('Forest header availiable', 'forest'),
          'priority'=>12,
          'panel'=>'forest_headers_pannel',
      ]);

      $wp_customize->add_setting( 'forest_change_header_setting', array(
          'transport'=>'refresh'
      ));

      $wp_customize->add_control(new Wp_Customize_Control($wp_customize,'forest_header_change_control',array(
          'label'=>__('Top Header','forest'),
          'section'=>'forest_change_header_section',
          'settings'=>'forest_change_header_setting',
          'type'=>'select',
          'choices' => array(
              '1'  => __( 'H-1' ),
              '2'  => __( 'H-2' ),
...
add_action( 'customize_register', 'forest_choose_custom_header' );

add_action('wp_head','headers_is_register');
function headers_is_register(){
    $header =  get_theme_mod('forest_change_header_setting');
