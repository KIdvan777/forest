...
require get_template_directory() . '/inc/customizer/sections/introduction/intro.php';
require get_template_directory() . '/inc/customizer/sections/portfolio/portfolio.php';
